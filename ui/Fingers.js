/* Copyright © 2015-2016 David Valdman */
    ...
    var Surface = require('../Widget/Surface');
    ...
    function handleStart(data){
        ...
        this.add({size : [this.options.diameter, this.options.diameter], origin : [.5, .5]})
            .add({transform : transform, opacity : opacity})
